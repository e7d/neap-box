...
* [PHP](http://php.net/) 7.0.15, as server-side scripting language, with:
    * [PHP-FPM](http://php-fpm.org/) 7.0.15, as PHP process manager
...
* [UnrealIRCd](https://www.unrealircd.org/) 4.0.10, as IRC server daemon, with:
