...
NGINX_VERSION=1.9.14 # http://nginx.org/en/download.html
OPENSSL_VERSION=1.0.2g # https://openssl.org/source/
NGINX_RTMP_VERSION=master #v1.1.7.10 # https://github.com/sergey-dryabzhinsky/nginx-rtmp-module/releases
...
(
	...
	cd /usr/src
	wget https://github.com/sergey-dryabzhinsky/nginx-rtmp-module/archive/${NGINX_RTMP_VERSION}.tar.gz -O nginx-rtmp-module-${NGINX_RTMP_VERSION}.tar.gz
